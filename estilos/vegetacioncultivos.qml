...
<qgis version="2.12.0-Lyon" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer">
    <rules key="{226cce44-89c9-4b47-a198-73c3b910b976}">
      <rule scalemaxdenom="100000" filter="tipo = 'Plantaciones Perennes'" key="{2f748839-c6da-420e-b45a-2cd6f0ef336d}" symbol="0" scalemindenom="1" label="Plantaciones Perennes"/>
      <rule scalemaxdenom="1000000" filter="tipo = 'Terreno para Cultivo'" key="{b40ef0f2-340a-4764-bcb4-b50f6d5bbb53}" scalemindenom="1" label="Terreno para Cultivo">
        <rule scalemaxdenom="100000" key="{e5d11f0d-30de-4b23-8cef-26c5f547819d}" symbol="1" scalemindenom="1" label="1 - 100000"/>
        <rule scalemaxdenom="500000" key="{5198da9a-cad7-4fa4-80e9-fa906ec5d449}" symbol="2" scalemindenom="100000" label="100000 - 250000"/>
      </rule>
    </rules>
    <symbols>
        ...
        <layer pass="0" class="LinePatternFill" locked="0">
          ...
          <symbol alpha="1" clip_to_extent="1" type="line" name="@0@0">
            <layer pass="0" class="SimpleLine" locked="0">
              ...
              <prop k="customdash" v="5;2;4;4;3;5;2;6;1;3;6;2"/>
